import SortList from '../view/trip-list-sort-view.js';
...
export default class TripPresenter {
  #waypointListComponent = new PointsList();
  ...
  #renderSort() {
    this.#sortComponent = new SortList({
  ...
  #renderNoWaypoint() {
    this.#noWaypointMessage = new NoPointMessage({
