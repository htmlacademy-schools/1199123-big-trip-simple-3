...
import { isSortDisabled } from '../utils/sort.js';
import { capitalizeType } from '../utils/item-utils.js';
import { SortTypeForDrawing } from '../utils/constant.js';

const createSortItemTemplate = (sortType) => (`
  <div class="trip-sort__item  trip-sort__item--${sortType} ">
    <input id="sort-${sortType}" class="trip-sort__input  visually-hidden" type="radio" name="trip-sort" value="sort-${sortType}" ${isSortDisabled(sortType)} ${(sortType === 'day' ? 'checked' : '')}>
