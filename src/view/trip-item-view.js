import { getEventDate, getDateWithoutT, getDateWithT, getTime } from '../utils/date';
...
function createWaypointTemplate(oneWaypoint, destinations, offers) {
  ...
  return (
    ...
    <div class="event">
      <time class="event__date" datetime="${getDateWithoutT(oneWaypoint.dateFrom)}">${getEventDate(oneWaypoint.dateFrom)}</time>
